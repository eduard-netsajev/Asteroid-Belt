...
class Game(object):
    ...
    def __init__(self):
        ...
        self.crash_sound = pygame.mixer.Sound("sound/explosion.ogg")
        self.levelup_sound = pygame.mixer.Sound("sound/levelup.ogg")
        self.background_sound = pygame.mixer.Sound("sound/background.ogg")
...
def main():
    ...
    pygame.display.set_caption("Asteroid Belt by Eduard Netsajev")
